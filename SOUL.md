...
- Telegram bot: supporter des commandes courtes et deterministes (/help, /daily, /scenarios, /scenario <id> [tier], /profile, /drills, /weekly, /leaderboard, /halloffame) sans dupliquer la logique scenario/profil hors des modules purs
